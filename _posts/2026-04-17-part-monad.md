...
It may seem like there's an issue here. If I'm working in a total proof assistant, how do I talk about programs which may not terminate? Lean's Mathlib offers an elegant way to do this, and its theory is rooted in Dana Scott's *domain theory*, a subject which brings together order theory and topology to give mathematical semantics to programming languages. 

This three-part post will cover how to model and reason about potentially-diverging computations in Lean. I will explain the basics of domain theory, explore the internals of Lean's `Part` monad, and formalize a useful theorem in domain theory. We will then use Lean to define a small imperative programming language with loops, give it denotational semantics using `Part`, and prove that these programs satisfy their specifications.
