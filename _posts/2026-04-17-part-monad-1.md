...
Programming languages provide syntax to write programs which perform computations. To reason about our programs, the first step is to decide what programs *mean*. 

There are multiple approaches to programming language semantics, but here we will focus on the *denotational* approach. In denotational semantics, the meaning of a program is considered to be a mathematical object in some space. 
...
- Andrew M. Pitts, [_Lecture Notes on Denotational Semantics for the Computer Science Tripos, Part II_](https://www.cl.cam.ac.uk/teaching/1112/DenotSem/dens-notes-bw.pdf), University of Cambridge Computer Laboratory, ©1997–2012 A.M. Pitts, G. Winskel, M. Fiore.

- Samson Abramsky, _Domain Theory in Logical Form_, Annals of Pure and Applied Logic 51 (1991), 1–77.