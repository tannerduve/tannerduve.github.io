...
Free monads represent effectful sequential programs as pure syntactic data, separate from their interpretation. With regular monads, semantics is baked into the implementation, but free monads let you write "meaningless" programs in monadic `do` notation and choose any meaning you want later. For example, the same program could be interpreted in any of these ways.
